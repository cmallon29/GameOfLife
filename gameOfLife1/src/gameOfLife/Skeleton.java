...
public class Skeleton
{
	...
	private JLabel playerPic1, playerPic2, playerPic3, playerPic4;
	...
	private void initialize() {	
		...
		stopButton.setBounds(1345, 760, 150, 31);
//		stopButton.setBounds(1345, 976, 150, 31);
		...
		spinButton.setBounds(1345, 760, 150, 31);
		...
		for (int i = 0; i <= totPlayers; i++)
		{
		  ...
		  if(carChoice == 0)
		  {
				...
				player.get(i).setCarImage("src/gameOfLife/imgs/Profile pics/Blue Player.JPG");
		  }
		  if(carChoice == 1)
		  {
				...
				player.get(i).setCarImage("src/gameOfLife/imgs/Profile pics/Green Player.JPG");
		  ...
		  if(carChoice == 2)
		  {
				...
				player.get(i).setCarImage("src/gameOfLife/imgs/Profile pics/Pink Player.JPG");
		  ...
		  if(carChoice == 3)
		  {
				...
				player.get(i).setCarImage("src/gameOfLife/imgs/Profile pics/Purple Player.JPG");
		  }
		  if(carChoice == 4)
		  {
				...
				player.get(i).setCarImage("src/gameOfLife/imgs/Profile pics/Red Player.JPG");
		  }
		  if(carChoice == 5)
		  {
				...
				player.get(i).setCarImage("src/gameOfLife/imgs/Profile pics/Yellow Player.JPG");
		  }
		}		
		if(totPlayers == 0)
		{
...
//		frame.getContentPane().add(textField_98);
	...
	{
		player1= new JLabel();
		player1.setBounds(1280, 0, 400, 150);
		...
		playerPic1 = new JLabel();
		playerPic1.setBounds(1500, 0, 400, 150);
		playerPic1.setIcon(playerCar);
		frame.add(playerPic1);
		frame.add(player1);
//		ImageIcon playerCar = new ImageIcon(player.get(0).getCarImage());
...
//		player1Panel.setVisible(false);
	...
	{
		player2= new JLabel();
		player2.setBounds(1280, 150, 400, 150);
		...
		playerPic2 = new JLabel();
		playerPic2.setBounds(1500, 150, 400, 150);
		playerPic2.setIcon(playerCar);
		frame.add(playerPic2);
		frame.add(player2);
	...
	{
		player3= new JLabel();
		player3.setBounds(1280, 300, 400, 150);
		...
		playerPic3 = new JLabel();
		playerPic3.setBounds(1500, 300, 400, 150);
		playerPic3.setIcon(playerCar);
		frame.add(playerPic3);
		frame.add(player3);
	}
	public void setPlayerFour()
	{
		player4= new JLabel();
		player4.setBounds(1280, 450, 400, 150);
		...
		playerPic4 = new JLabel();
		playerPic4.setBounds(1500, 450, 400, 150);
		playerPic4.setIcon(playerCar);
		frame.add(playerPic4);
		frame.add(player4);
	}
	public void setPlayers(){
		ageLabel.setBounds(1280, 800, 150, 31);
		ageLabel.setBackground(Color.white);
		ageLabel.setOpaque(true);
		ageLabel.setText("<html>Retirement Age: "+maxAge+"<br>Current Age: " + age + "</html>");
		setPlayerOne();
		if (totPlayers >0)
		{
			setPlayerTwo();
	...
	{
		player1.setText("<html>Player 1 <br>Name: " + player.get(0).getName() + "<br>Money: " + player.get(0).getMoney()
				+ "<br>House: " + player.get(0).getHouse()+ "<br>Car: " + player.get(0).getCarColour()+"<br>Job: "+player.get(0).getJob()+
				"<br>Relationship: "+player.get(0).getRelationship()+
				"<br>Chilren: "+player.get(0).getChildren()+"</html>");
		player1.setBackground(Color.white);		
		if(totPlayers>0)
		{
			player2.setText("<html>Player 2 <br>Name: " + player.get(1).getName() + "<br>Money: " + player.get(1).getMoney()
					+ "<br>House: " + player.get(1).getHouse()+ "<br>Car: " + player.get(1).getCarColour()+"<br>Job: "+player.get(1).getJob()+
					"<br>Relationship: "+player.get(1).getRelationship()+
					"<br>Chilren: "+player.get(1).getChildren()+"</html>");
			player2.setBackground(Color.white);
			if(totPlayers>1)
			{
				player3.setText("<html>Player 3 <br>Name: " + player.get(2).getName() + "<br>Money: " + player.get(2).getMoney()
						+ "<br>House: " + player.get(2).getHouse()+ "<br>Car: " + player.get(2).getCarColour()+"<br>Job: "+player.get(2).getJob()+
						"<br>Relationship: "+player.get(2).getRelationship()+
						"<br>Chilren: "+player.get(2).getChildren()+"</html>");				
				player3.setBackground(Color.white);
				if(totPlayers>2)
				{
					player4.setText("<html>Player 4 <br>Name: " + player.get(3).getName() + "<br>Money: " + player.get(3).getMoney()
							+ "<br>House: " + player.get(3).getHouse()+ "<br>Car: " + player.get(3).getCarColour()+"<br>Job: "+player.get(3).getJob()+
							"<br>Relationship: "+player.get(3).getRelationship()+
							"<br>Chilren: "+player.get(3).getChildren()+"</html>");
					player4.setBackground(Color.white);
				}
			}
		}
		...
		else
		{
			...
			ageLabel.setBounds(1345, 800, 150, 31);
			ageLabel.setBackground(Color.white);
			ageLabel.setOpaque(true);
			ageLabel.setText("<html>Retirement Age: "+maxAge+"<br>Current Age: " + age + "</html>");
...
"the next morning won’t be as fun! Pay 20k and collect the pub crawl token.","Pub Crawl!",JOptionPane.OK_CANCEL_OPTION); 
	...
	public void lifeCards(){
			...
			if(lifeType == 2)
			{
				player.get(currentPlayer).setFame(true);
			}
			if(lifeType == 3)
			{
				player.get(currentPlayer).setPromotion();;
			}
			if(lifeType == 4)
			{
				player.get(currentPlayer).setAward(true);
			}
			if(lifeType == 5)
			{
				player.get(currentPlayer).setSpeak(true);
			}
	...
	public void endGame()
	{
		...
		endFrame.setBackground(Color.yellow);
		endFrame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
		endFrame.setResizable(false);
		endFrame.setVisible(true);
		JLabel headerImage = new JLabel();
		showWinner = new JButton("hello");
		showWinner.setVisible(true);
		showWinner.setBounds(570 , 425 , 430, 55);
		showWinner.setOpaque(true);
		showWinner.setContentAreaFilled(true);
		showWinner.setBorderPainted(true);
		winner = new Player();
		showWinner.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e)
			{
				for (Player m : player)
				{
					if(m.getMoney() > winner.getMoney())
					{
						winner = m;
					}
					JOptionPane.showMessageDialog( null, "Congradulations " + m.getName()
							+ " you finished the game with " +m.endGame()+ 
							" dollars.","Score",JOptionPane.OK_CANCEL_OPTION); 
				}
				JOptionPane.showMessageDialog( null, "The winner is... " + winner.getName()
						+ " you finished the game with " +winner.endGame()+ 
						" dollars.","House Denial",JOptionPane.OK_CANCEL_OPTION); 
			}
		});
		ImageIcon startIcon = new ImageIcon("src/gameOfLife/imgs/endGame.png");
		headerImage.setIcon(startIcon);
		headerImage.setBounds(400, 15, 675, 270);
		headerImage.setVisible(true);
		endFrame.add(headerImage);
		endFrame.add(showWinner);
	}
